...
class ProtT5_Embedder:
  ...
  def kmer_embed(self, identifier, input, att_mask, max_len, kmer_overlap=30):
      ...
      while True:
          ...
          count += 1
          identifiers.append(subseq_name)
  ...
  def embed_longbatch(self, pdb_ids, seq_lens, token_encoding, max_len):
      ...
      for batch_idx, identifier in enumerate(pdb_ids):
          ...
          if oom_err:
              ...
              kmered_identifier.append(identifier)
      ...
      return identifiers, embedding_lst
  ...
  def get_embeddings(self, seq_path, emb_path,
          ...
          if len(batch) >= max_batch or n_res_batch>=max_residues or seq_idx==len(seq_dict) or seq_len>max_seq_len:
              ...
              try:
                  ...
                  if split_kmer:
                      ...
                      continue
              if oom_err:
                  identifiers, embs_detach = self.embed_longbatch(pdb_ids,
      ...
      with h5py.File(emb_path, "w") as hf:
          ...
          #hf.attrs['Kmer Protein'] = kmered_prot
          #hf.attrs['List Prot Long'] = longprot_lst
...
def main(input_seq=None, input_txt=None, embed_out=None, model_path=None,
