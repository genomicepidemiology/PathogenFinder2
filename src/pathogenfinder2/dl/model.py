...
from pathogenfinder2.dl.dl_functions.test_model import Test_NeuralNetwork
from pathogenfinder2.dl.utils.nn_utils import Network_Module
from pathogenfinder2.dl.utils.data_utils import NN_Data
from pathogenfinder2.dl.utils.report_utils import ReportNN, Memory_Report
...
class Pathogen_DLModel:
    ...
    def predict_model(self, input_metapath:str, save_embeddings:bool=False, save_attentions:bool=False,
                        cge_output:bool=False):
        ...
        for ens in tqdm(range(amount_nets), total=amount_nets, desc="Infering from Neural Network Models", unit="Neural Network",
            ...
            results_inference = inference_instance(return_attentions=save_attentions,
